...
public class MyGraphics extends JPanel implements ActionListener {
	...
	private NgocGiau_Game algorithm;
	private MyLine line;
	...
	public void newGame() {
		algorithm = new NgocGiau_Game(this.row, this.col);
		addArrayButton();

	}

	//cập nhật lại mảng sau mỗi nút button
